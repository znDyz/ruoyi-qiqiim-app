<template>
	<view>
		...
		<!--分享窗口-->
		<view class="more-share-model" @tap="togle" v-if="shareShow"></view>
		<view class="more-share animated fadeInUp fast" v-if="shareShow">
			...
			<scroll-view scroll-x class="more-share-body">
				<view class="more-share-item" hover-class="more-share-hover">
					<view class="icon iconfont icon-weixin u-f-ajc more-share-1"></view>
					<view class="u-f-ajc">微信好友</view>
				</view>
				<view class="more-share-item" hover-class="more-share-hover">
					<view class="icon iconfont icon-xinlangweibo u-f-ajc more-share-2"></view>
					<view class="u-f-ajc">朋友圈</view>
				</view>
				<view class="more-share-item" hover-class="more-share-hover">
					<view class="icon iconfont icon-weixin u-f-ajc more-share-3"></view>
					<view class="u-f-ajc">新浪微博</view>
				</view>
				<view class="more-share-item" hover-class="more-share-hover">
					<view class="icon iconfont icon-QQ u-f-ajc more-share-4"></view>
					<view class="u-f-ajc">QQ好友</view>
				</view>
				<view class="more-share-item" hover-class="more-share-hover">
					<view class="icon iconfont icon-shouye u-f-ajc more-share-5"></view>
					<view class="u-f-ajc">其他</view>
				</view>
			</scroll-view>
			<view class="more-share-title u-f-ajc" 
				  hover-class="more-share-hover" @tap="togle">取消
			</view>
		</view>
	</view>
</template>
